...
from MLLM.common.dist_utils import download_cached_file, is_main_process, main_process, is_dist_avail_and_initialized
from MLLM.common.registry import registry
from MLLM.common.utils import is_url
from MLLM.datasets.data_utils import concat_datasets, reorg_datasets_by_split
from MLLM.runners.runner_base import RunnerBase
...
class RunnerIter(RunnerBase):
    ...
    def __init__(self, cfg, task, model, datasets, job_id):
        ...
        # # 创建优化器时确保使用FP32参数
        # self.optimizer = self.create_optimizer(model.parameters())
