...
from MLLM.models.blip2 import Blip2Base, disabled_train
...
class BLIVAVicuna(Blip2Base):
    ...
    PRETRAINED_MODEL_CONFIG_DICT = {
        ...
        "llama7b": "configs/models/bliva_llama7b.yaml",
        "llama13b": "configs/models/bliva_llama13b.yaml",
        "pmcllama": "configs/models/bliva_pmcllama.yaml",
        "llama7b_150K": "configs/models/bliva_llama7b_150K.yaml",
        "llama3": "configs/models/bliva_llama3.yaml",
    }
    ...
    def forward(self, samples):
        ...
        text_output_tokens = self.llm_tokenizer(
            [str(t) + self.llm_tokenizer.eos_token for t in samples['text_output']],
            return_tensors="pt",
            padding="longest",
            truncation=True,
    ...
    def generate(
        ...
        # keywords = ["</s>", "###", "<s>", " "]
        # keywords = [""]
        # stopping_criteria = KeywordsStoppingCriteria(keywords, self.llm_tokenizer, llm_tokens.input_ids)
